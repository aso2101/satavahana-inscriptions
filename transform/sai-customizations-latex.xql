        ...
        ()
                    ...
                    if (ancestor::listApp) then
                        (
                            ...
                            if (@source) then
                                ...
                                (),
                            if (@resp) then
                                latex:inline($config, ., ("tei-lem3"), @resp)
                            else
                                (),
                            latex:inline($config, ., ("tei-lem4", "sep"), '. ')
                        )

                    else
                        latex:inline($config, ., ("tei-lem5"), .)
                ...
                case element(rdg) return
                    (
                        ...
                        if (@resp) then
                            latex:inline($config, ., ("tei-rdg2"), @resp)
                        else
                            (),
                        latex:text($config, ., ("tei-rdg3"), ' '),
                        if (@source) then
                            (: No function found for behavior: refbibl :)
                            $config?apply($config, ./node())
                        else
                            (),
                        latex:inline($config, ., ("tei-rdg5", "sep"), '. ')
                    )
